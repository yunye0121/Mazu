...
MODEL_CKPT_FOLDER="/work/yunye0121/work/yunye0121/MazuTW_training_results/MazuTW_trainwithselfpred_st400eps_seed1126_traindt2013010101-2018123123_valdt2022010101-2022123123_lt1_intw1_rs1_th1_epoch100_lr3e-5_trainbs32_valbs32/ckpts/checkpoint-50"
MODEL_CKPT_PATH="${MODEL_CKPT_FOLDER}/model.safetensors"
OUTPUT_FOLDER_NAME="ar_selfpred_rs1_bs1_dt20230101-20231231_lt1_intw1"
...
python ./AuroraSmallTW_gen_eval_pipeline_custom_rollout.py \
    ...
    --input_time_window 1 \
    --rollout_step 1 \
    --save_rollout_step 1 6 24 96 168 \
    --timestep_hours 1 \
    --mixed_precision 'no' \
    --eval_metric MSE MAE \
    --gen_result_folder "/work/yunye0121/dis_data/${OUTPUT_FOLDER_NAME}/preds" \
    --csv_output_folder "/work/yunye0121/dis_data/${OUTPUT_FOLDER_NAME}/errs" \
    2>&1 | tee "${LOG_FILE}" \
