...
def parse_args():
    parser = argparse.ArgumentParser(description = "Pangu Training Script (HF Style)")
...
def create_model(args):
    # --- MIGRATED FROM USER SNIPPET ---
    
    # 1. Initialize the Base Pangu Model
    # Note: Ensure the constant mask paths exist on this machine
    ...
    # IMPORTANT: If your loss function relies on normalization, fill this dictionary 
    # with the actual stats (mean, std) for your variables.
    surf_stats_dummy = {} 
...
def train_epoch(
    ...
    for batch in pbar:
        ...
        with accelerator.autocast():
            ...
            _pred = model(_input) # Forward via Adapter
            
            # Note: _model.surf_stats is accessed here. Ensure it's populated if Normalization is needed.
            loss_dict = criterion(
